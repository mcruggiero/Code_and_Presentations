...
def bring_in(filename):
    try:
        bpy.ops.import_mesh.ply(filepath="/Users/michaelruggiero/Desktop/BucketOfChips/" + filename)
        ...
        os.remove("/Users/michaelruggiero/Desktop/BucketOfChips/" + filename)
        print("/Users/michaelruggiero/Desktop/BucketOfChips/" + filename + " Removed")
        pass
...
for i in range(1000,1002):
    ...
    while count < 151:
        NewChip = random.choice(os.listdir("/Users/michaelruggiero/Desktop/BucketOfChips/"))
