...
# In the game of Go, groups of stones are removed when
# They are completely surrounded by other stones. The amount
# of spaces that prevent this capture is called liberty.
# Counting liberties is carried by this class. Ultimetly,
# the idea is that dealing with groups of stones and liberties 
# At the same time reduces complexity. 
...
class GoString():  # <1>
    ...
    #Access the size of liberties by calling this below
    @property
    def num_liberties(self):
        print(len(self.liberties))
...
# This is the first listing from this module, the idea 
# is that players can make one of three moves.
...
# From page 32: Note that so far, the Player , Point , and Move classes are all plain
# data types.Although they’re fundamental to representing the board, they don’t contain any
# game logic. This is done on purpose, and you’ll benefit from separating game-play concerns like this.
